function drawSkillsBarChart(data) {
    ...
    // Tổng số Job Id (đếm tất cả skillCounts)
    ...
    svg.selectAll(".bar")
        ...
        .on("mouseover", function(event, d) {
            ...
            const percent = ((d.count / totalJobs) * 100).toFixed(2); // Tính phần trăm

            tooltip.transition()
                .duration(200)
                .style("opacity", 0.9);
            tooltip.html(`Skill: ${d.skill}<br>Jobs: ${d.count}<br>Percentage: ${percent}%`)
